...
def _make_vector2_canvas_widget(port, parent=None):
    from PySide6.QtWidgets import QWidget, QHBoxLayout, QLineEdit

    vals = _parse_vec2(port.value)
...
def _make_vector2_inspector_widget(port):
...
register_port_type(PortTypeSpec(
    ...
    canvas_widget_factory=_make_vector2_canvas_widget,
    inspector_widget_factory=_make_vector2_inspector_widget,
    aliases=["vec2"],
))
