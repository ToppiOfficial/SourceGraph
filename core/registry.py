...
def discover_nodes(nodes_dir: str = "") -> None:
	"""Dynamically scan subdirectories in the nodes folder and register all node classes.

	Args:
		nodes_dir: Path to the nodes directory. If empty, uses previously stored path.
	"""
