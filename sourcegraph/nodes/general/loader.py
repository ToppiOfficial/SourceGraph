...
from sourcegraph.sys.node import BaseNode, In, OptIn, Out, port_uses_graph_variables
...
class SessionNode(BaseNode):
    ...
    def _show_session_dialog(self):
        from sourcegraph.gui.menu.file_search_dialog import SessionSearchDialog
