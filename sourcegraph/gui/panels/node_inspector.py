...
from sourcegraph.gui.commands import PropertyCommand
from sourcegraph.gui.menu.file_search_dialog import GenericSelectionDialog
from sourcegraph.gui.widgets.port_utils import port_is_inspector_editable as _port_is_editable, validate_port_text as _validate_port_text, PortDot
from sourcegraph.gui.widgets.ui_helpers import make_separator as _make_separator, position_near_cursor as _position_near_cursor
...
# Style aliases - defined in gui.theme, available via `from gui.theme import *`
_TITLE_EDIT_STYLE    = INSPECTOR_TITLE_EDIT_STYLE
_SECTION_LABEL_STYLE = INSPECTOR_SECTION_LABEL_STYLE
_PORT_LABEL_STYLE    = INSPECTOR_PORT_LABEL_STYLE
_CONN_HINT_STYLE     = INSPECTOR_CONN_HINT_STYLE
