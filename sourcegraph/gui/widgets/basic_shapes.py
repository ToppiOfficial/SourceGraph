...
class IconColors:
    ...
    CONNECT = QColor(86, 156, 214)   # light blue  - wire/connect actions
    FOLD    = QColor(180, 140, 90)   # amber       - fold/unfold history actions
    DEFAULT = QColor(136, 136, 136)  # gray        - generic/unknown actions
